...
public class Options implements Page, MouseMotionListener, MouseListener {
	...
	private void init() {
		...
		allPageEntities.add(new TextElement("Options", 100, 100, 100, Color.WHITE));
